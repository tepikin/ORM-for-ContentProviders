...
package ru.lazard.commons.settings;
...
public class SettingsTest extends AndroidTestCase {
    ...
    /**
     * Test method for
     * {@link ru.lazard.commons.settings.Settings#Settings(SharedPreferences)
     */
    public void testConstructors() {
        Settings settings;
        // {@link ru.lazard.commons.settings.Settings#Settings(android.content.Context)
        settings = new Settings(getContext());
        settings.setBoolean("KEY_BOOLEAN", true);

        // {@link ru.lazard.commons.settings.Settings#Settings(Context, String)
        settings = new Settings(getContext(), "settings");
        settings.setBoolean("KEY_BOOLEAN", true);

        // {@link ru.lazard.commons.settings.Settings#Settings(Context, String, int)
    ...
    /**
     * Test method for
     * {@link ru.lazard.commons.settings.Settings#setBoolean(String, boolean) 
     */
    ...
    /**
     * Test method for
     * {@link ru.lazard.commons.settings.Settings#setFloat(String, float) 
     */
    ...
    /**
     * Test method for
     * {@link ru.lazard.commons.settings.Settings#setInt(String, int) 
     */
    ...
    /**
     * Test method for
     * {@link ru.lazard.commons.settings.Settings#setLong(String, long) 
     */
    ...
    /**
     * Test method for
     * {@link ru.lazard.commons.settings.Settings#setString(String, String) 
     */
