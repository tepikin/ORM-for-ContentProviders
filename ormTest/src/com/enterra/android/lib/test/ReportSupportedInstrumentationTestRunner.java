package com.enterra.android.lib.test;
 ...
 * 
 */
public class ReportSupportedInstrumentationTestRunner extends InstrumentationTestRunner {
    ...
    private static final String TAG = ReportSupportedInstrumentationTestRunner.class.getSimpleName();
